System.register(['angular2/core', 'angular2/router', '../service/mongoapi.service'], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            EditFileComponent = (function () {
                function EditFileComponent(service) {
                    this.service = service;
                    this.formSubmitted = false;
                    this.loaded = false;
                }
                EditFileComponent.prototype.onSubmit = function (fileForm) {
                    // edit
                    //this.service.mongoPostTest("files", fileForm.form.value).subscribe();
                    this.formSubmitted = true;
                };
                EditFileComponent.prototype.loadData = function (fileid) {
                    var _this = this;
                ...
                return EditFileComponent;
            })();
            exports_1("EditFileComponent", EditFileComponent);
        }
    }
});
//# sourceMappingURL=edit-file.component.js.map
    ...
    return {
        ...
        execute: function() {
            MongoAPIService = (function () {
                ...
                MongoAPIService.prototype.mongoDelete = function (collection, mongoID) {
                    return this.http.delete(this.mongoURL + collection + "/" + mongoID + '?apiKey=' + this.apiKey).map(function (res) { return res.json(); });
                };
